...
function NgSelectComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NgSelectComponent_Conditional_9_Conditional_0_Template, 1, 1, "ng-container", 18)(1, NgSelectComponent_Conditional_9_Conditional_1_Template, 4, 2, "span", 25);
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
...
function NgSelectComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵrepeaterCreate(2, NgSelectComponent_Conditional_12_For_3_Template, 4, 24, "div", 28, ɵɵcomponentInstance().trackByOption, true);
